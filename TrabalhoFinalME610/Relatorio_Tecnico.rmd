...
- Mês da gravidez onde a dor começou  
- Números de filhos anteriores  
- A paciente teve dor nas costas em gravidezes anteriores?  
...
```{r}
a111 <- ddply(dados,~`Intensidade Dor`,summarise,Contagem = sum(dados_base[,11]),n = length(dados_base[,11]),prop = Contagem/n)
```
